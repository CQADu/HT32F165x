...
/* Settings ------------------------------------------------------------------------------------------------*/
  ...
  #define HTCFG_OUTPUT_LED0_AFIO_PIN                            (AFIO_PIN_10)
  ...
  #define HTCFG_OUTPUT_LED0_GPIO_PIN                            (GPIO_PIN_10)
  ...
  #define HTCFG_OUTPUT_LED0_AFIO_PIN                            (AFIO_PIN_13)
  ...
  #define HTCFG_OUTPUT_LED0_GPIO_PIN                            (GPIO_PIN_13)
